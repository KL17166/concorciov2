...
const CAPABILITIES: Record<AdminRole, readonly AdminCapability[]> = {
    MASTER: [
        ...
        'security.manage', 'support.view', 'support.manage', 'notifications.view',
        'notifications.manage', 'account.security'
    ],
    MANAGER: [
        'dashboard.view', 'people.view', 'people.create', 'people.edit_profile',
        ...
        'compliance.review', 'integrations.view', 'support.view', 'support.manage',
        'notifications.view', 'notifications.manage', 'account.security'
    ],
    SUPPORT: [
        'dashboard.view', 'people.view', 'contracts.view', 'payments.view',
        'bids.view', 'catalog.view', 'compliance.view', 'support.view',
        'support.manage', 'notifications.view', 'account.security'
    ],
    CLIENT: []
};
